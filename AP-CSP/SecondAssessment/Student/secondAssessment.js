...
for(flipCounter; flipCounter<4; flipCounter++){
 ...
 * Problem 1b:
 * 
 * Uncomment the code belwo and fill in the missing statements so that the correct 
 * message is displayed depending on the number of heads and tails flipped.
 */
